  ...
  return (
    <main className='py-40 px-10 text-neutral-700 flex items-center justify-evenly w-full '>
        <section className='w-2/5 p-6 flex flex-col items-center gap-10'>
            ...
            <img src={img1} alt="img1" width={200} className='drop-shadow-lg drop-shadow-neutral-800'/>
            <p> Soy Lucas Mella, un apasionado del desarrollado web que busca transformar ideas en soluciones sencillas y productos visualmente atractivos. <br /><br />
                ...
                Si quieres conocer otro de mis trabajos, puedes visitar mi proyecto: <a className='text-blue-600 text-lg hover:text-blue-400' href="https://taskify-three-mu.vercel.app/">Taskify</a>.
            </p>
        </section>
        ...
        <section className='w-2/5 p-6 flex flex-col items-center gap-10 '>
            ...
            <p> LibroScope es una plataforma que facilita descubrir y organizar libros de forma inteligente, similar a como Netflix recomienda películas. <br /><br />
